        ...
        <Box sx={{ bgcolor: 'white', borderRadius: '12px', width: '35%', height: 'fit-content' }}>
          <TabContext value={value}>
            <Box sx={{ borderBottom: 1, borderColor: 'divider' }}>
              <TabList aria-label='Tabs' onChange={handleChange} textColor='primary' sx={{ '& .MuiTab-textColorPrimary': { color: 'black', fontWeight: '500', fontSize: '18px' } }}>
                <Tab label='Login' value='1' sx={{ width: '50%', '& .MuiTab-textColorPrimary': { color: 'green' } }} />
            ...
            <TabPanel value='1'>
              <Stack sx={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '24px' }}>
                ...
                <FormControl fullWidth sx={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
                  ...
                  <Button variant='outlined' sx={{ fontWeight: '500', py: '10px', borderRadius: '8px', width: '70%', mx: 'auto', my: '10px', bgcolor: '#F7941D', color: '#0C3547', border: 'none', '&:hover': { bgcolor: '#F7941D', color: '#0C3547', border: 'none' } }}>LOGIN</Button>
                </FormControl>
              </Stack>
            </TabPanel>
            {/* .....................signup..................... */}
            <TabPanel value='2'>
              <Stack sx={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '24px' }}>
                ...
                <FormControl fullWidth sx={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
                  ...
                  <TextField placeholder='Password' />
                  <FormControlLabel control={<Checkbox defaultChecked />} label="Remember Password" sx={{ width: 'fit-content', my: '0px', color: '#A5A4A4', '& .MuiCheckbox-root': { py: 0 } }} />
                  <Button variant='outlined' sx={{ fontWeight: '500', py: '10px', borderRadius: '8px', width: '70%', mx: 'auto', my: '10px', bgcolor: '#F7941D', color: '#0C3547', border: 'none', '&:hover': { bgcolor: '#F7941D', color: '#0C3547', border: 'none' } }}>SignUp</Button>
                </FormControl>
              </Stack>
            </TabPanel>
          </TabContext>
